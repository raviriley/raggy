  ...
  try {
    ...
    for (let i = 0; i < transactions.length; i++) {
      ...
      try {
        ...
        console.log(`📝 [LETTA EMBED] Embedding transaction ${i+1}/${transactions.length}: ${name}`);
        console.log(`✅ [LETTA EMBED] Source ID created: ${data.id} for transaction ${i+1}`);
    ...
    console.log(`🎉 [LETTA EMBED] Completed embedding ${sourceIds.length}/${transactions.length} transactions`);
