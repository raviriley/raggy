    ...
    const testDocs = [
      {
        ...
        content:
          "This is a test document about blockchain and cryptocurrencies.",
      },
      {
        title: "Test Document 2",
        content:
          "Flare Network provides Oracle services and cross-chain interoperability.",
      },
      {
        title: "Test Document 3",
        content:
          "Vector databases are used for similarity search in RAG applications.",
      },
    ];
