...
docker build --tag=${coredb_image_tag} \
    ...
    --label="tee.launch_policy.allow_env_override=NEO4J_AUTH,NEO4J_ACCEPT_LICENSE_AGREEMENT,NEO4J_dbms_memory_heap_initial__size,NEO4J_dbms_memory_heap_max__size" \
